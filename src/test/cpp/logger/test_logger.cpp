...
namespace test
{
    ...
    struct Tests
    {
        ...
        static void LoggerStringSinkMultiple()
        {
            std::string buffer;
        ...
        inline const static Test<void> logger_string_sink_multiple {
            "logger_string_sink_multiple", LoggerStringSinkMultiple
        };

        static void loggerFileSink()
        {
        ...
        static void LoggerMultiStringAndFileSinks()
        {
            std::string buffer_1;
            // create string sinks
        ...
        static void LoggerConsoleSinkRedirectsStdout()
        {
